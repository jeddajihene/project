...
import { getDecoratorAction } from "../redux/Actions/servicesCardsActions";
...
const Decorators = () => {
  ...
  return (
    <div style={{ paddingTop: 90 }}>
      <h1 className="title-page-proprofile">Decorators</h1>
      <div className="profiles-pro-container">
        {servicesCardsReducer.decorator?.map((el, i) => (
          // profil is a props//
